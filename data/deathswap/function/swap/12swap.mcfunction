...
tag @r[tag=!out, tag=!swap0, tag=!swap1, tag=!swap2, tag=!swap3, tag=!swap4, tag=!swap5, tag=!swap6, tag=!swap7, tag=!swap8, tag=!swap9, tag=!swap10] add swap11
...
execute at @a[tag=swap11] run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,Tags:["aswap11"],NoGravity:1b}
